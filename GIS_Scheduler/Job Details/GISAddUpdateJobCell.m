...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    _startTime_label.text=NSLocalizedStringFromTable(@"select_no_of_expected_attendees", TABLE, nil);;
    
    _endTime_label.text=NSLocalizedStringFromTable(@"select_no_of_expected_attendees", TABLE, nil);;

    _callInTime_label.text=NSLocalizedStringFromTable(@"Call_In_Time", TABLE, nil);;

    _payLevel_label.text=NSLocalizedStringFromTable(@"select_no_of_expected_attendees", TABLE, nil);;
    ...
    _cancelled_label.text=NSLocalizedStringFromTable(@"select_no_of_expected_attendees", TABLE, nil);;

    _payType_label.text=NSLocalizedStringFromTable(@"select_no_of_expected_attendees", TABLE, nil);;

    _outAgency_label.text=NSLocalizedStringFromTable(@"Out_Agency", TABLE, nil);;
    _yes_outAgency_label.text=NSLocalizedStringFromTable(@"select_no_of_expected_attendees", TABLE, nil);;
    _no_outAgency_label.text=NSLocalizedStringFromTable(@"select_no_of_expected_attendees", TABLE, nil);;
    _timelyAndHalf_label.text=NSLocalizedStringFromTable(@"Timely_and_Half", TABLE, nil);;
    _yes_timelyAndHalf_label.text=NSLocalizedStringFromTable(@"select_no_of_expected_attendees", TABLE, nil);;
    _no_timelyAndHalf_label.text=NSLocalizedStringFromTable(@"select_no_of_expected_attendees", TABLE, nil);;
    _billingPaymentInfo_label.text=NSLocalizedStringFromTable(@"BillOrPayment_Info", TABLE, nil);;
    _notesHistory_label.text=NSLocalizedStringFromTable(@"select_no_of_expected_attendees", TABLE, nil);;

...
#define CREATE_TBL_UNIT_EVENT_TYPE @"CREATE TABLE IF NOT EXISTS TBL_UNIT_EVENT_TYPE(ID TEXT PRIMARY KEY, TYPE TEXT,VALUE TEXT)"
...
#define CREATE_TBL_CHOOSE_REQUEST @"CREATE TABLE IF NOT EXISTS TBL_CHOOSE_REQUEST(ID INTEGER PRIMARY KEY, TYPE TEXT,VALUE TEXT)"

#define CREATE_TBL_SEARCH_CHOOSE_REQUEST @"CREATE TABLE IF NOT EXISTS TBL_SEARCH_CHOOSE_REQUEST(ID INTEGER PRIMARY KEY, TYPE TEXT,VALUE TEXT)"

#define CREATE_TBL_SPJOBS_CHOOSE_REQUEST @"CREATE TABLE IF NOT EXISTS TBL_SPJOBS_CHOOSE_REQUEST(ID INTEGER PRIMARY KEY, TYPE TEXT,VALUE TEXT)"
...
#define CREATE_TBL_BILL_LEVEL @"CREATE TABLE IF NOT EXISTS TBL_BILL_LEVEL(ID TEXT PRIMARY KEY, TYPE TEXT,VALUE TEXT)"
...
#define CREATE_TBL_REQUESTORS @"CREATE TABLE IF NOT EXISTS TBL_REQUESTORS(ID TEXT PRIMARY KEY, TYPE TEXT,VALUE TEXT)"
#define CREATE_TBL_CREATED_BY @"CREATE TABLE IF NOT EXISTS TBL_CREATED_BY(ID TEXT PRIMARY KEY, TYPE TEXT,VALUE TEXT)"
#define CREATE_TBL_MODE_JOBASSIGNMENT @"CREATE TABLE IF NOT EXISTS TBL_MODE_JOBASSIGNMENT(ID TEXT PRIMARY KEY, TYPE TEXT,VALUE TEXT)"
#define CREATE_TBL_REQUESTOR_TYPE @"CREATE TABLE IF NOT EXISTS TBL_REQUESTOR_TYPE(ID TEXT PRIMARY KEY, TYPE TEXT,VALUE TEXT)"
...
#define CREATE_TBL_SERVICE_PROVIDER_INFO @"CREATE TABLE IF NOT EXISTS TBL_SERVICE_PROVIDER_INFO(ID TEXT PRIMARY KEY, TYPE TEXT,SPTYPE TEXT,SERVICE_PROVIDER TEXT)"

#define CREATE_TBL_SCHEDULE_SERVICE_PROVIDER_INFO @"CREATE TABLE IF NOT EXISTS TBL_SCHEDULE_SERVICE_PROVIDER_INFO(ID TEXT PRIMARY KEY, TYPE TEXT,SPTYPE TEXT,SERVICE_PROVIDER TEXT)"
